...
// node_modules/@strapi/upload/dist/_chunks/index-Clesg6BA.mjs
...
import "C:/threads/WP-Finals-Social-Media/threads-backend/node_modules/cropperjs/dist/cropper.css";
...
var PreviewBox = ({
  ...
  const handleDuplication = async () => {
    ...
    await upload({ name: file.name, rawFile: file }, ((_a2 = asset.folder) == null ? void 0 : _a2.id) ? asset.folder.id : null);
...
var admin = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-D1ayH-QS-GRJX3SPE.js").then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-BYC3ism8-OUVFMQ7T.js");
...
cropperjs/dist/cropper.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-T2ELGRV4.js.map
